...
#define kSureColor [UIColor colorWithRed:74.0/255.0 green:184.0/255.0 blue:173.0/255.0 alpha:1]
...
- (void)buttonClick:(id)sender
{
    ...
    if ([self.delegate respondsToSelector:@selector(alertView:clickedButtonAtIndex:)]) {
        [self.delegate alertView:(UIAlertView *)self clickedButtonAtIndex:button.tag];
    }
